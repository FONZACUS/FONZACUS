...
// @grant GM_setValue
// @grant GM_getValue
// @downloadURL https://raw.githubusercontent.com/FONZACUS/FONZACUS/userscript/torn/Target_Hunter_Extended.js
// @updateURL https://raw.githubusercontent.com/FONZACUS/FONZACUS/userscript/torn/Target_Hunter_Extended.js
// ==/UserScript==
...
const TORN_JOBS = {
1: 'Unemployed',2: 'Grocery Store',3: 'Law Firm',4: 'Hair Salon',
5: 'Army',6: 'Casino',7: 'Education',8: 'Oil Rig',
9: 'Medical',10: 'Car Dealership',11: 'Gun Shop',12: 'Flower Shop',
13: 'Zoo',14: 'Night Club',15: 'Candle Shop',16: 'Cyber Cafe'
};

const DEFAULT_SETTINGS = {
minID: 9,maxID: 4000000,
minLevel: 1,maxLevel: 100,
apiKey: '',
maxRetries: 15,
openInNewTab: true,useAttackLink: false,

useBattleStatsFilter: false,
battleStatsFilterType: 'total',

minTotalStats: 0,maxTotalStats: 1000000000,

minStrength: 0,maxStrength: 1000000000,
minDefense: 0,maxDefense: 1000000000,
minSpeed: 0,maxSpeed: 1000000000,
minDexterity: 0,maxDexterity: 1000000000,

useJobFilter: false,
jobFilterType: 'include',
selectedJobs: [],

useLastActionFilter: false,
lastActionFilterType: 'include',
selectedTimeRanges: [],

useCompanyFilter: false,
companyFilterType: 'exclude',
companyFilterMethod: 'any',
selectedCompanies: [],
companySearchText: ''
};
...
const userJobId = job ? job.job_id : 1;
