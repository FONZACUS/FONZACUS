...
*,::after,::before,
*:not(a):not(button):not(btn):not(i):not(icon):not(img):not(pic):not(span):not(svg)
:not(area):not(audio):not(map):not(svg):not(track):not(progress)
:not(embed):not(iframe):not(object):not(picture):not(geolocation)
:not(canvas):not(math):not(source):not(media):not(video)
{
